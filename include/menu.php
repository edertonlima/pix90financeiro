            ...
            <div class="scroll">
                <ul class="list-unstyled">
                    ...
                    <li class="<?php if($page == 'cadastro'): echo 'active'; endif; ?>">
                        <a href="#cadastro">
                            <i class="iconsminds-male-female"></i> Cadastro
                        </a>
                    </li>
            ...
            <div class="scroll">
                ...
                */ ?>
                <ul class="list-unstyled" data-link="cadastro" id="cadastro">
                    <li class="<?php if($subpage == 'cadastro-all'): echo 'active'; endif; ?>">
                        <a href="<?php echo $home_url; ?>/cadastro-todos.php">
                            <i class="simple-icon-list"></i> <span class="d-inline-block">Todos os Cadastros</span>
                        </a>
                    </li>
                    <li class="<?php if($subpage == 'cadastro-novo'): echo 'active'; endif; ?>">
                        <a href="<?php echo $home_url; ?>/cadastro-novo.php">
                            <i class="iconsminds-add-user"></i> <span class="d-inline-block">Cadastrar Novo</span>
                        </a>
                    </li>
                    <?php /*
                    <li>
                        <a href="Pages.Auth.Login.html">
                            <i class="iconsminds-male-female"></i> <span
                                class="d-inline-block">Colaboradores</span>
                        </a>
                    </li>
                    <li>
                    ...
                    */ ?>
                    ...
                    <li>
                        <a href="#" data-toggle="collapse" data-target="#collapseProduct" aria-expanded="true"
                            ...
                            <i class="simple-icon-arrow-down"></i> <span class="d-inline-block">Cadastrar Novo</span>
                        </a>
